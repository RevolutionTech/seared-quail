...
class MenuItemInitialOrdersMigrationTestCase(MigrationTestCase):
    ...
    def setUpBeforeMigration(self, apps):
        ...
        self.premigration_menuitem = MenuItem.objects.create(
            category=category, name="House Salad"
        )
...
class MenuAdminWebTestCase(SearedQuailTestCase):
    def get200s(self):
        return [
            ...
            "/admin/menu/category/{category_id}/change/".format(
                category_id=self.category.id
            ),
            "/admin/menu/menuitem/",
            "/admin/menu/menuitem/add/",
            "/admin/menu/menuitem/{menu_item_id}/change/".format(
    ...
    def testCategoryCannotBeAncestorOfSelf(self):
        ...
        data = {"name": "Juices", "parent": self.category.id}
    ...
    def testUserCanOrderMenuItemSetting(self):
        ...
        self.assertResponseRedirects(
            url, "/admin/menu/menuitem/", method="POST", data=data
        )
